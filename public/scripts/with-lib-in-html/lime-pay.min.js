(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["LimePayWeb"] = factory();
	else
		root["LimePayWeb"] = factory();
})(window, function() {
...
var VALIDATION_ERROR = __webpack_require__(136).VALIDATION_ERROR;

var getNotDefinedMessage = function getNotDefinedMessage(isNotDefined) {
  return "".concat(isNotDefined ? ' or is not defined' : '');
};

module.exports = {
  NOT_AN_OBJECT: function NOT_AN_OBJECT(propertyName, includeNotDefined) {
    return {
      errorName: VALIDATION_ERROR,
      code: 2000,
      message: "".concat(propertyName, " is not an object").concat(getNotDefinedMessage(includeNotDefined))
    };
  },
  NOT_A_STRING: function NOT_A_STRING(propertyName, includeNotDefined) {
    return {
      errorName: VALIDATION_ERROR,
      code: 2040,
      message: "".concat(propertyName, " is not a string").concat(getNotDefinedMessage(includeNotDefined))
    };
  },
  NOT_A_BOOLEAN: function NOT_A_BOOLEAN(propertyName, includeNotDefined) {
    return {
      errorName: VALIDATION_ERROR,
      code: 2030,
      message: "".concat(propertyName, " is not a boolean").concat(getNotDefinedMessage(includeNotDefined))
    };
  },
  INVALID_LENGTH: function INVALID_LENGTH(propertyName, includeNotDefined) {
    return {
      errorName: VALIDATION_ERROR,
      code: 2050,
      message: "".concat(propertyName, " is not with appropriate length").concat(getNotDefinedMessage(includeNotDefined))
    };
  },
  NOT_A_FUNCTION: function NOT_A_FUNCTION(propertyName, includeNotDefined) {
    return {
      errorName: VALIDATION_ERROR,
      code: 2060,
      message: "".concat(propertyName, " is not a function").concat(getNotDefinedMessage(includeNotDefined))
    };
  },
  NOT_DEFINED: function NOT_DEFINED(propertyName) {
    return {
      errorName: VALIDATION_ERROR,
      code: 2000,
      message: "".concat(propertyName, " is not defined")
    };
  }
};
...
var FormValidator = __webpack_require__(361);

var ConfigValidator = __webpack_require__(362);

var thirdPartyPaymentProvider = __webpack_require__(137);

var thirdPartyPaymentProviderConfig = __webpack_require__(363);

var InitializationService = function () {
  var isFormInitialized = false;

  var validateLimePayToken = function validateLimePayToken(limePayToken) {
    if (!InitializationService.isValidLimePayToken(limePayToken)) {
      throw new Error(JSON.stringify(constants.ERRORS.INVALID_LIME_PAY_TOKEN));
    }
  };
  ...
  function () {
    ...
    _createClass(InitializationService, null, [{
      key: "init",
      value: function () {
        var _init = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee(limePayToken, config) {
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  validateLimePayToken(limePayToken);
                  ConfigValidator.validate(config);
                  FormValidator.validate();
                  this.limePayToken = limePayToken;
                  _context.next = 6;
                  return _retrieveBSToken(limePayToken, config.URL);

                case 6:
                  this.paymentToken = _context.sent;

                  _buildThirdPartyConfigFromLimeConfig(config);

                  thirdPartyPaymentProvider.hostedPaymentFieldsCreation(this.paymentToken, config);

                  _preventActionPaymentForm();
      ...
      key: "initRelayedPayment",
      value: function initRelayedPayment(limePayToken, config) {
        validateLimePayToken(limePayToken);
        ConfigValidator.validate(config);
        this.limePayToken = limePayToken;
      ...
      key: "isInitializedCorrect",
      value: function isInitializedCorrect() {
        return isFormInitialized;
      }
    }, {
      key: "isValidLimePayToken",
      value: function isValidLimePayToken(limePayToken) {
        if (limePayToken && limePayToken.toString().indexOf('.') >= 0) {
          var tokenParts = limePayToken.split('.');
  ...
  var _buildThirdPartyConfigFromLimeConfig = function _buildThirdPartyConfigFromLimeConfig(limeConfig) {
    limeConfig.isFailedSubmit = false;
    Object.assign(limeConfig, thirdPartyPaymentProviderConfig);
    var onErrorFn = limeConfig.onFieldEventHandler.onError;

    limeConfig.onFieldEventHandler.onError = function (tagId, errorCode) {
      onErrorFn(tagId, errorCode);

      if (limeConfig.isFailedSubmit) {
        limeConfig.isFailedSubmit = false;
        limeConfig.eventHandler.onFailedSubmit({
          message: 'Invalid data in a hosted field'
        });
      }
    };
  };

  var _preventActionPaymentForm = function _preventActionPaymentForm() {
  ...
  var _retrieveBSToken =
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(limePayToken, BASE_URL) {
      var token;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return axios({
                url: BASE_URL + constants.URLs.TOKEN_PATH,
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
                  "x-lime-token": limePayToken,
            ...
            case 2:
              ...
              return _context2.abrupt("return", token.data.paymentToken);
    ...
    return function _retrieveBSToken(_x3, _x4) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(345)))

/***/ }),
/* 96 */
/***/ (function(module, exports, __webpack_require__) {

var errorNames = __webpack_require__(136);

module.exports = {
  ERRORS: {
    INCORRECT_FORM_INITIALIZATION: {
      errorName: errorNames.GLOBAL_ERROR,
      code: 9070,
      message: "Form is not initialized properly"
    },
    INVALID_LIME_PAY_TOKEN: {
      errorName: errorNames.TOKEN_VERIFICATION,
      code: 1140,
      message: "Invalid LimePay token"
    },
    NO_TRANSACTIONS_PROVIDED: {
      errorName: errorNames.TRANSACTION_VALIDATION_ERROR,
      code: 3020,
      message: "No transactions provided!"
    },
    INCORRECT_ARRAY_OF_SIGNED_TRANSACTIONS: {
      errorName: errorNames.TRANSACTION_VALIDATION_ERROR,
      code: 3120,
      message: "The provided signed transactions are not an array"
    },
    NO_SIGNED_TRANSACTIONS: {
      errorName: errorNames.TRANSACTION_VALIDATION_ERROR,
      code: 3020,
      message: "It should have at least one signed transaction."
    },
    INVALID_TX_FORMAT: function INVALID_TX_FORMAT(tx) {
      return {
        errorName: errorNames.TRANSACTION_VALIDATION_ERROR,
        code: 3110,
        message: "Transaction has been provided with invalid format. TX: " + JSON.stringify(tx)
      };
    },
    WALLET_CONFIGURATION_ERROR: {
      errorName: errorNames.WALLET_ERROR,
      code: 8000,
      message: 'Wallet configuration is not provided or it is not valid!'
    }
  },
  URLs: {
    TOKEN_PATH: "/v1/checkout/token",
    GAS_PRICE_NONCE_PATH: "/v1/checkout/gaspriceandnonce/"
  }
};
...
module.exports = {"GLOBAL_ERROR":"GLOBAL_ERROR","VALIDATION_ERROR":"VALIDATION_ERROR","TOKEN_VERIFICATION":"TOKEN_VERIFICATION_ERROR","TRANSACTION_VALIDATION_ERROR":"TRANSACTION_VALIDATION_ERROR","WALLET_ERROR":"WALLET_ERROR"};
...
var bluesnap = function () {
  var a,
      e,
      t,
      n,
      i = !0,
      r = "https://includestest.ccdc02.com/cardinalcruise/v1/songbird.js",
      o = "https://sandbox.bluesnap.com/services/hosted-payment-fields/v2.0/bluesnap.iframe.html#",
      s = {
    token: "",
    style: {},
    ...
    exp: !1,
    responseJSON: {},
    setSuccess: function setSuccess(e, t) {
      if (this[e] = !0, "ccn" === e) {
        var n = JSON.parse(t);
        this.responseJSON.ccType = n.ccType, this.responseJSON.last4Digits = n.last4Digits, this.responseJSON.issuingCountry = "Planet Earth";

        try {
          null != n.issuingCountry && (this.responseJSON.issuingCountry = n.issuingCountry);
        } catch (e) {
          w("JSON error, " + e);
        }
      }

      "exp" === e && (this.responseJSON.exp = t), this.cvv && this.ccn && this.exp && this.callback && (w("All three iFrames updated successfully"), !0 === l["3DS"] && 0 < Object.keys(d["3DS"]).length ? D({
        tagId: "ccn",
        event: "authenticateWith3DS",
        threeDSecureFields: d["3DS"],
        jwt: f
      }) : this.callback(this.responseJSON));
    },
    setCallBack: function setCallBack(e) {
      this.ccn = u.indexOf("ccn") < 0, this.cvv = u.indexOf("cvv") < 0, this.exp = u.indexOf("exp") < 0, this.callback = e;
    },
    set3DSAuthenticationResult: function set3DSAuthenticationResult(e) {
      var t = {};
      t.authResult = e, this.responseJSON.threeDSecure = t, this.callback(this.responseJSON);
    }
  };

  function m() {
    try {
      this.ccn = y("ccn"), this.cvv = y("cvv"), this.exp = y("exp");
    } catch (e) {
      console.log("Missing IFrame id, " + e);
    }
  }

  function y(e) {
    return c.hostedPaymentFields.hasOwnProperty(e) ? document.querySelector("[data-bluesnap=" + c.hostedPaymentFields[e] + "]") : null;
  }
  ...
  function g(e) {
    ...
    try {
      ...
      console.log("this is not a valid id, " + e);
    }
  }
  ...
  function S() {
    ...
    try {
      "_" !== s.token.slice(-1) && (o = "https://www" + s.token.slice(-1) + ".bluesnap.com/services/hosted-payment-fields/v2.0/bluesnap.iframe.html#"), i = o;
    } catch (e) {
      w("cannot retreive domain, " + e);
    }

    try {
      u.forEach(function (e) {
        var t, n, a;
        g(e).innerHTML = (t = e, n = i, a = document.location.origin, "<iframe frameborder='0' style='border: medium none; width: 100%; height: 100%; float: left;' src='" + (n += window.btoa(a + t + ("exp" === t && s.expDropDownSelector ? "_" : ""))) + "' allowtransparency='true' scrolling='no' type=" + t + " name='bluesnap-hosted-iframe-" + t + "' id='bluesnap-hosted-iframe-" + t + "'></iframe>"), "exp" === e && document.querySelector("#bluesnap-hosted-iframe-exp").setAttribute("bluesnapselect", s.expDropDownSelector);
      });
    } catch (e) {
      w("cannot create iframes, " + e);
    }
  }

  function b(e) {
    if ("put" === e.event) w("Received success response for Put request from iFrame [" + e.tagId + "]"), h.setSuccess(e.tagId, e.param);else try {
      var t = "on" + ((n = e.event).charAt(0).toUpperCase() + n.slice(1));

      switch (t) {
        case "onError":
          c.onFieldEventHandler[t](e.tagId, e.errorCode, e.errorDescription);
          break;

        case "onType":
          c.onFieldEventHandler[t](e.tagId, e.cardType);
          break;

        default:
          c.onFieldEventHandler[t](e.tagId);
      }
    } catch (e) {
      console.log("onFieldEventHandler is not valid, " + e);
    }
    var n;
  }

  function D(e) {
    g(e.tagId).querySelectorAll("iframe[id^='bluesnap-hosted-iframe-']")[0].contentWindow.postMessage(JSON.stringify(e), o.split("/services/")[0]);
  }

  function w(e) {
    !1 === i && console.log("BS.Main: " + e);
  }

  function x() {
    var e, t, n;
    "_" !== s.token.slice(-1) && (r = "https://includes.ccdc02.com/cardinalcruise/v1/songbird.js"), w("Loading cardinalcruise js"), e = r, t = function t() {
      var e = "off";
      !1 === i && (e = "on"), Cardinal.configure({
        logging: {
          level: e
        }
      }), Cardinal.on("payments.setupComplete", function () {
        w("payments.setupComplete callback was called"), null != a && (w("Enabling the submit button"), a.disabled = !1);
      }), Cardinal.on("payments.validated", function (e, t) {
        var n;
        w("payments.validated callback was called"), w(JSON.stringify(e)), n = t, w("Posting processAuthenticationResult message to iFrame[ccn]"), D({
          tagId: "ccn",
          event: "processAuthenticationResult",
          jwt: f,
          resultJwt: n
        });
      });
    }, (n = document.createElement("script")).type = "text/javascript", n.src = e, n.onreadystatechange = t, n.onload = t, document.head.appendChild(n);
  }

  return e = window, t = "message", n = function n(e) {
    if (e.origin === o.split("/services/")[0]) {
      var t,
          n = "";
      if (e.data) try {
        n = JSON.parse(e.data);
      } catch (e) {
        w("JSON parse error, " + e);
      }
      if ("implementation" === n.event) w("Received implementation message from iFrame [" + n.tagId + "]"), w("Posting implementation message back to iFrame [" + n.tagId + "]"), D({
        tagId: n.tagId,
        event: "implementation",
        tokenAndStyle: s
      }), !0 === l["3DS"] && !1 === v && !1 === p && (w("Jwt wasn't created nor sent. Posting createJwt message to iFrame [" + n.tagId + "]"), p = !0, D({
        tagId: n.tagId,
        event: "createJwt"
      }));else if ("cardinalSetup" === n.event) w("Received cardinalSetup message from internal.js. Setting jwtCreated = true"), v = !0, f = n.jwt, t = f, w("Calling Cardinal.setup"), Cardinal.setup("init", {
        jwt: t
      });else if ("cardinalContinue" === n.event) {
        w("Received cardinalContinue message from internal.js");
        var a = n.enrollmentData,
            i = a.enrollmentStatus;
        "Yes" === i ? function (e) {
          w("Calling Cardinal.continue");
          var t = {
            AcsUrl: e.acsUrl,
            Payload: e.payload
          },
          ...
          Cardinal.continue("cca", t, n);
        }(a) : (w("enrollmentStatus = " + i), h.set3DSAuthenticationResult(i));
      } else "authenticationResult" === n.event ? (w("Received authenticationResult message from internal.js"), h.set3DSAuthenticationResult(n.authResult)) : b(n);
    }
  }, e.addEventListener ? e.addEventListener(t, n, !1) : e.attachEvent ? e.attachEvent("on" + t, n) : e["on" + t] = n, {
    submitCredentials: function submitCredentials(e, t) {
      h.setCallBack(e);
      ...
      var n,
        ...
        if (!0 === l["3DS"]) {
          var t = e.amount,
              n = e.currency,
              a = "";
          if ("number" != typeof t && "string" != typeof n ? a = " { amount, currency }" : "number" != typeof t ? a = " { amount }" : "string" != typeof n && (a = " { currency }"), "" !== a) return {
            tagId: "ccn",
            event: "error",
            errorCode: "14102",
            errorDescription: "3D Secure object is missing required fields" + a
          };
          d["3DS"] = e;
        }
      }(t);

      null == a ? (w("Posting " + (n = "put") + " message to iFrames"), u.forEach(function (e) {
        D({
          tagId: e,
          event: n
        });
    ...
    hostedPaymentFieldsCreation: function hostedPaymentFieldsCreation(e, n) {
      u = [], n.hostedPaymentFields = {}, document.querySelectorAll("[data-bluesnap]").forEach(function (e) {
        var t = e.getAttribute("data-bluesnap");
        "submitButton" === t ? a = e : "ccn" !== t && "cvv" !== t && "exp" !== t || (u[u.length] = t, n.hostedPaymentFields[t] = t);
      });

      var t = function (e) {
        var t = {
          styles: ["color", "font", "font-family", "font-size", "font-style", "font-weight", "line-height", "opacity", "outline", "text-shadow", "transition", "left"],
          fields: ["#ccn", "#ccn:focus", "#ccn.valid", "#ccn.invalid", "#cvv", "#cvv:focus", "#cvv.valid", "#cvv.invalid", "#year", "#year:focus", "#year.valid", "#year.invalid", "#month", "#month:focus", "#month.valid", "#month.invalid", "input", "::placeholder", "::-webkit-input-placeholder", "::-moz-placeholder", ":-ms-input-placeholder", ":-moz-placeholder", ":focus", ".valid", ".invalid", ".valid:focus", ".invalid:focus", "span", "select"]
        };

        if ("object" == _typeof(e.style) && null !== e.style) {
          for (var n in e.style) {
            if (-1 === t.fields.indexOf(n)) return [!1, "error"];

            for (var a in e.style[n]) {
              if (-1 === t.styles.indexOf(a)) return [!1, "error"];
            }
          }
      ...
      t[0] ? ("object" === t[1] ? s.style = n.style : delete s.style, s.token = e, void 0 !== n.ccnPlaceHolder && null !== n.ccnPlaceHolder && (s.ccnPlaceHolder = n.ccnPlaceHolder), void 0 !== n.cvvPlaceHolder && null !== n.cvvPlaceHolder && (s.cvvPlaceHolder = n.cvvPlaceHolder), void 0 !== n.expPlaceHolder && null !== n.expPlaceHolder && (s.expPlaceHolder = n.expPlaceHolder), void 0 !== n.expDropDownSelector && null !== n.expDropDownSelector && (s.expDropDownSelector = n.expDropDownSelector), void 0 !== n["3DS"] && null !== n["3DS"] && !0 === n["3DS"] && (l["3DS"] = !0, null != a && (a.disabled = !0), x()), c.hostedPaymentFields = n.hostedPaymentFields, c.onFieldEventHandler = n.onFieldEventHandler, S()) : console.log(t[1] + " check style did not pass");
    }
  };
}();
...
var InitializationService = __webpack_require__(94);

var PaymentServiceInstance = __webpack_require__(364);

var TransactionsBuilder = __webpack_require__(366);
...
var main = {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return InitializationService.init(limePayToken, config);

            case 2:
              main.PaymentService = new PaymentServiceInstance(config);
              main.TransactionsBuilder = new TransactionsBuilder(config.URL);
              main.utils = {};
              main.utils.calculateVAT = utils.initCalculateVAT(limePayToken, config.URL);
  ...
  initRelayedPayment: function () {
    var _initRelayedPayment = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(limePayToken, config) {
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return InitializationService.initRelayedPayment(limePayToken, config);
    ...
    return function initRelayedPayment(_x3, _x4) {
      return _initRelayedPayment.apply(this, arguments);
    };
  }(),
  PaymentService: {},
  TransactionsBuilder: {},
...
var errorMessages = __webpack_require__(66);
...
function () {
  ...
  _createClass(FormValidator, null, [{
    ...
    value: function validate() {
      return FormValidator.hasCheckoutForm() && FormValidator.hasExpDate() && FormValidator.hasCVV() && FormValidator.hasCardNumber();
    }
  }, {
    key: "hasCheckoutForm",
    value: function hasCheckoutForm() {
      var checkoutForm = document.getElementById('checkout-form');

      if (!checkoutForm && checkoutForm.tagName != 'FORM') {
        throw new Error(JSON.stringify(errorMessages.NOT_DEFINED('Document element with id [checkout-form]')));
      }
    }
  }, {
    key: "hasExpDate",
    value: function hasExpDate() {
      var expDate = document.getElementById('exp-date');

      if (!expDate && expDate.getAttribute('data-bluesnap') != 'exp') {
        throw new Error(JSON.stringify(errorMessages.NOT_DEFINED('Document element with id [exp-date]')));
      }
    }
  }, {
    key: "hasCVV",
    value: function hasCVV() {
      var cvv = document.getElementById('cvv');

      if (!cvv && cvv.getAttribute('data-bluesnap') != 'cvv') {
        throw new Error(JSON.stringify(errorMessages.NOT_DEFINED('Document element with id [cvv]')));
      }
    }
  }, {
    key: "hasCardNumber",
    value: function hasCardNumber() {
      var cardNumber = document.getElementById('card-number');

      if (!cardNumber && cardNumber.getAttribute('data-bluesnap') != 'ccn') {
        throw new Error(JSON.stringify(errorMessages.NOT_DEFINED('Document element with id [card-number]')));
      }
    }
  }]);
...
function () {
  ...
  _createClass(ConfigValidator, null, [{
    key: "validate",
    value: function validate(config) {
      if (!config || config.constructor.name !== 'Object') {
        throw new Error(JSON.stringify(errorMessages.NOT_AN_OBJECT('config')));
      } // Validate that LimePay URL is set


      if (!config.URL || typeof config.URL !== "string") {
        throw new Error(JSON.stringify(errorMessages.NOT_A_STRING('URL', true)));
      } // Validate event handlers


      if (config.eventHandler) {
        // Validate that event handler onSuccessfulSubmit is defined
        if (!config.eventHandler.onSuccessfulSubmit || !(config.eventHandler.onSuccessfulSubmit instanceof Function)) {
          throw new Error(JSON.stringify(errorMessages.NOT_A_FUNCTION('eventHandler.onSuccessfulSubmit', true)));
        } // Validate that event handler onFailedSubmit is defined


        if (!config.eventHandler.onFailedSubmit || !(config.eventHandler.onFailedSubmit instanceof Function)) {
          throw new Error(JSON.stringify(errorMessages.NOT_A_FUNCTION('eventHandler.onFailedSubmit', true)));
        }
      } else {
        throw new Error(JSON.stringify(errorMessages.NOT_DEFINED('eventHandler')));
      }
    }
  }]);
...
/* eslint-disable */
var BlueSnapCheckoutConfiguration = function () {
  var configuration = {
    onFieldEventHandler: {
      onFocus: function onFocus(tagId) {
        // Handle focus
        changeImpactedElement(tagId, "", "hosted-field-focus");
      },
      onBlur: function onBlur(tagId) {
        // Handle blur 
        changeImpactedElement(tagId, "hosted-field-focus");
      },
      onError: function onError(tagId, errorCode) {
        // Handle a change in validation by displaying help text
        document.getElementById("".concat(tagId, "-help")).textContent = getErrorText(errorCode);
      },
      onType: function onType(tagId, cardType) {
        // get card type from cardType and display card image
        document.getElementById('card-logo').children[0].setAttribute('src', cardUrl[cardType]);
      },
      onValid: function onValid(tagId) {
        // Handle a change in validation by removing any help text
        document.getElementById("".concat(tagId, "-help")).textContent = "";
      }
    },
    style: {
      // Styling all inputs
  ...
  function changeImpactedElement(tagId, removeClass, addClass) {
    ...
    addClass = addClass || "";
    var impactedElement = document.querySelector("[data-bluesnap=".concat(tagId, "]"));
    if (removeClass) impactedElement.classList.remove(removeClass);
    if (addClass) impactedElement.classList.add(addClass);
...
module.exports = BlueSnapCheckoutConfiguration.configuration;
...
var CardHolderInformationValidator = __webpack_require__(365);

var wrappedPaymentService = function () {
  var configuration;

  var initializationCheck = function initializationCheck() {
    if (!InitializationService.isInitializedCorrect()) {
      throw new Error(JSON.stringify(constants.ERRORS.INCORRECT_FORM_INITIALIZATION));
    }
  };

  var signedTransactionCheck = function signedTransactionCheck(signedTransactions) {
    if (!Array.isArray(signedTransactions)) {
      throw new Error(JSON.stringify(constants.ERRORS.INCORRECT_ARRAY_OF_SIGNED_TRANSACTIONS));
    } else if (signedTransactions.length == 0) {
      throw new Error(JSON.stringify(constants.ERRORS.NO_SIGNED_TRANSACTIONS));
    }
  };
  ...
  function () {
    ...
    _createClass(PaymentService, [{
      ...
      value: function () {
        ...
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee2(cardHolderInformation, signedTransactions) {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  initializationCheck();
                  validationErrors = CardHolderInformationValidator.validate(cardHolderInformation);

                  if (validationErrors) {
                    configuration.eventHandler.onFailedSubmit(JSON.stringify(validationErrors));
                  }

                  signedTransactionCheck(signedTransactions);
                  configuration.isFailedSubmit = true;
                  thirdPartyPaymentProvider.submitCredentials(
                  /*#__PURE__*/
                  function () {
                    var _ref = _asyncToGenerator(
                    /*#__PURE__*/
                    regeneratorRuntime.mark(function _callee(cardData) {
                      var authTokens;
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              try {
                                configuration.isFailedSubmit = false;
                                authTokens = {
                                  limePayToken: InitializationService.limePayToken,
                                  bsToken: InitializationService.paymentToken
                                };

                                _createPayment(authTokens, cardHolderInformation, signedTransactions);
                              } catch (err) {
                                configuration.eventHandler.onFailedSubmit({
                                  message: err.message
                                });
                              }
      ...
      key: "processRelayedPayment",
      value: function () {
        var _processRelayedPayment = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee3(signedTransactions) {
              ...
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  try {
                    ...
                    _createRelayedPayment(InitializationService.limePayToken, signedTransactions);
                  } catch (err) {
                    configuration.eventHandler.onFailedSubmit({
                      message: err.message
                    });
        ...
        return function processRelayedPayment(_x4) {
          return _processRelayedPayment.apply(this, arguments);
        };
      }()
    }]);
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee4(authTokens, cardHolderInformation, signedTransactions) {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              requestData = {
                paymentToken: authTokens.bsToken,
                cardHolderInformation: cardHolderInformation,
                signedTransactions: signedTransactions
              };
              request = {
                url: "".concat(configuration.URL, "/v1/checkout"),
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                  "x-lime-token": authTokens.limePayToken,
                  "Cache-Control": "no-cache"
                },
                data: requestData
              };
            ...
            case 5:
              configuration.eventHandler.onSuccessfulSubmit();
              _context4.next = 11;
              break;
            ...
            case 8:
              ...
              configuration.eventHandler.onFailedSubmit(_context4.t0.response);
    ...
    return function _createPayment(_x5, _x6, _x7) {
      return _ref2.apply(this, arguments);
    };
  }();

  var _createRelayedPayment =
  /*#__PURE__*/
  function () {
    var _ref3 = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee5(limePayToken, signedTransactions) {
      var requestData, request;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              request = {
                url: "".concat(configuration.URL, "/v1/checkout/relayed"),
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
                  "x-lime-token": limePayToken,
            ...
            case 8:
              ...
              configuration.eventHandler.onFailedSubmit(_context5.t0.response);
    ...
    return function _createRelayedPayment(_x8, _x9) {
...
module.exports = wrappedPaymentService;
...
var CardHolderInformationValidator =
/*#__PURE__*/
function () {
  function CardHolderInformationValidator() {
    _classCallCheck(this, CardHolderInformationValidator);
  }

  _createClass(CardHolderInformationValidator, null, [{
    key: "validate",
    value: function validate(cardHolderInformation) {
      var validationErrors = [];

      if (!cardHolderInformation || cardHolderInformation.constructor.name !== 'Object') {
        validationErrors.push(errorMessages.NOT_AN_OBJECT('CardHolderInformation'));
      }

      if (!cardHolderInformation.name || typeof cardHolderInformation.name !== "string") {
        validationErrors.push(errorMessages.NOT_A_STRING('CardHolderInformation.name'));
      }

      if (!!cardHolderInformation.isCompany || typeof cardHolderInformation.isCompany !== "boolean") {
        validationErrors.push(errorMessages.NOT_A_BOOLEAN('CardHolderInformation.isCompany'));
      }

      if (!cardHolderInformation.vatNumber || typeof cardHolderInformation.vatNumber !== "string") {
        validationErrors.push(errorMessages.NOT_A_STRING('CardHolderInformation.vatNumber'));
      }

      if (!cardHolderInformation.countryCode || typeof cardHolderInformation.countryCode !== "string") {
        validationErrors.push(errorMessages.NOT_A_STRING('CardHolderInformation.address.countryCode'));
      }

      if (!cardHolderInformation.zip || typeof cardHolderInformation.zip !== "string") {
        validationErrors.push(errorMessages.NOT_A_STRING('CardHolderInformation.address.zip'));
      }

      if (!cardHolderInformation.street || typeof cardHolderInformation.street !== "string") {
        validationErrors.push(errorMessages.NOT_A_STRING('CardHolderInformation.address.street'));
      }
    }
  }]);

  return CardHolderInformationValidator;
}();

module.exports = CardHolderInformationValidator;
...
var ethers = __webpack_require__(367);

var constants = __webpack_require__(96);

var InitializationService = __webpack_require__(94);

var wrappedTransactionBuilder = function () {
  var BASE_URL;

  var initWalletFromConfiguration =
  /*#__PURE__*/
  function () {
    var _ref = _asyncToGenerator(
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee2(configuration) {
      var stringifyError, wallet, initWalletByJSON, _initWalletByJSON, initWalletByPrivateKey, initWalletByMnemonic;

      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              initWalletByMnemonic = function _ref5(mnemonicConfiguration) {
                var mnemonicWallet;

                if (mnemonicConfiguration.nonEnglishLocaleWorldList) {
                  mnemonicWallet = ethers.Wallet.fromMnemonic(mnemonicConfiguration.mnemonic, null, mnemonicConfiguration.nonEnglishLocaleWorldList);
                } else {
                  mnemonicWallet = ethers.Wallet.fromMnemonic(mnemonicConfiguration.mnemonic);
                }

                return mnemonicWallet;
              };

              initWalletByPrivateKey = function _ref4(privateKey) {
                var newWallet = new ethers.Wallet(privateKey);
                return newWallet;
              };

              _initWalletByJSON = function _ref3() {
                _initWalletByJSON = _asyncToGenerator(
                /*#__PURE__*/
                regeneratorRuntime.mark(function _callee(json, password) {
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          return _context.abrupt("return", ethers.Wallet.fromEncryptedJson(json, password));
                ...
                return _initWalletByJSON.apply(this, arguments);
              };

              initWalletByJSON = function _ref2(_x2, _x3) {
                return _initWalletByJSON.apply(this, arguments);
              };

              stringifyError = JSON.stringify(constants.ERRORS.WALLET_CONFIGURATION_ERROR);
            ...
            case 13:
              if (!(configuration.decryptedWallet && configuration.decryptedWallet.address)) {
                _context2.next = 17;
                break;
              }

              wallet = configuration.decryptedWallet;
              _context2.next = 26;
              break;
            ...
            case 17:
              ...
              wallet = initWalletByPrivateKey(configuration.privateKey);
              _context2.next = 26;
              break;

            case 21:
              if (!configuration.mnemonic) {
                _context2.next = 25;
                break;
              }

              wallet = initWalletByMnemonic(configuration.mnemonic);
              _context2.next = 26;
              break;
    ...
    return function initWalletFromConfiguration(_x) {
      return _ref.apply(this, arguments);
    };
  }();

  var TransactionsBuilder =
  /*#__PURE__*/
  function () {
    function TransactionsBuilder(url) {
      _classCallCheck(this, TransactionsBuilder);

      BASE_URL = url;
    } // example of wallet configuration
    // wallet configuration should have one of those properties
    // let walletConfiguration = {
    //     encryptedWallet: {
    //         jsonWallet: encryptedWallet,
    //         password: password
    //     },
    ...
    //     mnemonic: {
    //         mnemonic: mnemonic,
    //         nonEnglishLocaleWorldList: null | bg | ko
    //     }
    // }


    _createClass(TransactionsBuilder, [{
      key: "buildSignedTransactions",
      value: function () {
        var _buildSignedTransactions = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee3(walletConfiguration, transactions) {
          var wallet, request, response, nonceCounter, gasPrice, signedTransactions, i, txOptions, contractInstance, functionParameters, signedTx;
          return regeneratorRuntime.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  throw new Error(JSON.stringify(constants.ERRORS.NO_TRANSACTIONS_PROVIDED));

                case 2:
                  _context3.next = 4;
                  return initWalletFromConfiguration(walletConfiguration);

                case 4:
                  wallet = _context3.sent;
                  request = {
                    url: "".concat(BASE_URL).concat(constants.URLs.GAS_PRICE_NONCE_PATH) + wallet.address,
                    method: "GET",
                    headers: {
                      "Content-Type": "application/json",
                      "x-lime-token": InitializationService.limePayToken,
                      "Cache-Control": "no-cache"
                    }
                  };
                  _context3.next = 8;
                ...
                case 8:
                  ...
                  nonceCounter = response.data.nonce;
                  gasPrice = ethers.utils.bigNumberify(response.data.gasPrice);
                  signedTransactions = [];
                  i = 0;
                ...
                case 13:
                  ...
                  if (isValidTx(transactions[i])) {
                    _context3.next = 16;
                    break;
                  }

                  throw new Error(JSON.stringify(constants.ERRORS.INVALID_TX_FORMAT(transactions[i])));
                ...
                case 16:
                  ...
                  contractInstance = new ethers.Contract(transactions[i].to, transactions[i].abi, wallet);
                  functionParameters = transactions[i].functionParams || [];
                  _context3.next = 21;
                  return createSignedTransaction(contractInstance, transactions[i].functionName, wallet, txOptions, transactions[i].to, functionParameters);
        ...
        return function buildSignedTransactions(_x4, _x5) {
          return _buildSignedTransactions.apply(this, arguments);
        };
      }()
    }]);
  ...
  function isValidTx(tx) {
    // TX Should be: {to: X, abi: Y, gasLimit: Z, value, fnName, ...params}
    return tx && tx.to && tx.abi && Number.isInteger(tx.gasLimit) && Number.isInteger(tx.value) && tx.functionName;
  }

  function createSignedTransaction(contract, functionToExecute, wallet, transactionOptions, to, functionParams) {
    var currentFunc = contract.interface.functions["".concat(functionToExecute)];
    var encodedFunc = currentFunc.encode(functionParams);

    var funcTx = _objectSpread({}, transactionOptions, {
      data: encodedFunc,
      to: to
    });

    return wallet.sign(funcTx);
  }

  return TransactionsBuilder;
}();

module.exports = wrappedTransactionBuilder;
...
var CardHolderVATDataValidator = __webpack_require__(369);

var axios = __webpack_require__(65);

var utils = {
  initCalculateVAT: function initCalculateVAT(limePayToken, envURL) {
    var envUrl = envURL;
    var token = limePayToken;
    return (
      /*#__PURE__*/
      function () {
        var _ref = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee(cardHolderVATData) {
          var request, vat;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  CardHolderVATDataValidator.validate(cardHolderVATData);
                  request = {
                    url: "".concat(envUrl, "/v1/checkout/vat"),
                    method: "POST",
                    headers: {
                      "Content-Type": "application/json",
                      "x-lime-token": token,
                ...
                case 4:
                  vat = _context.sent;
                  return _context.abrupt("return", vat);
...
var CardHolderVATDataValidator =
/*#__PURE__*/
function () {
  function CardHolderVATDataValidator() {
    _classCallCheck(this, CardHolderVATDataValidator);
  }

  _createClass(CardHolderVATDataValidator, null, [{
    key: "validate",
    value: function validate(cardHolderVATData) {
      if (!cardHolderVATData || cardHolderVATData.constructor.name !== 'Object') {
        throw new Error(JSON.stringify(errorMessages.NOT_AN_OBJECT('vatObject')));
      }

      if (!cardHolderVATData.countryCode || typeof cardHolderVATData.countryCode !== "string" || cardHolderVATData.countryCode.length != 2) {
        throw new Error(JSON.stringify(errorMessages.NOT_A_STRING('countryCode', true)));
      }

      if (typeof cardHolderVATData.isCompany !== "boolean") {
        throw new Error(JSON.stringify(errorMessages.NOT_A_BOOLEAN('isCompany', true)));
      }
    }
  }]);

  return CardHolderVATDataValidator;
}();

module.exports = CardHolderVATDataValidator;
